  ...
  return (
    <div className="flex items-center justify-between p-6 border-b border-gray-100">
      ...
      <div className="flex items-center gap-2">
        {/* See in Calendar button */}
        {onCalendarClick && (
          <button
            onClick={() => {
              const taskDate = task.dueDate ? new Date(task.dueDate) : new Date();
              onCalendarClick(taskDate);
            }}
            className="px-3 py-2 text-sm font-medium text-gray-600 hover:text-gray-800 rounded-lg hover:bg-black hover:bg-opacity-5 transition-all flex items-center gap-2"
            title="See in Calendar"
          >
