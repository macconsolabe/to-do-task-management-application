...
interface WelcomeStepEmailProps {
  value: string;
  error?: string;
...
export function WelcomeStepEmail({ value, error, onNext, isVisible }: WelcomeStepEmailProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className={`text-center max-w-md w-full transition-all duration-500 transform ${
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-500 font-light">Step 2 of 3</p>
        </div>
